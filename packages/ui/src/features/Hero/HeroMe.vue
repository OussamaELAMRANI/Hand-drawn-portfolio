...
<template>
  ...
  >
    <div>
      <div class="-rotate-[1.5deg] font-hand text-xl text-cyan">// hey there, I'm</div>
      <h1
      ...
      <p class="mb-[22px] max-w-[30ch] font-display text-[32px] leading-[1.15]">
        I build <UiHighlight class="text-[32px]">solid web products</UiHighlight> &amp; chase good
        light in far-off places.
      </p>
      <p class="mb-[30px] max-w-[52ch] text-body text-ink-600 dark:text-chalk-600">
        Senior Full-Stack Engineer. I ship end-to-end with <strong>TypeScript / Node.js</strong> on
        the back, <strong>Next.js, Nuxt &amp; Vue</strong> on the front, and lean on
